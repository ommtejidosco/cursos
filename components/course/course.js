...
function unidad(courseId, id, numero, nombre, activo){
  return `<li class='${activo?'active':''}'><a class='item' href='/courses/${courseId}/units/${id}' data-navigo><div class='media media--center'><div class='circle circle--gray circle--lg'>U${numero}</div><span class='media-body'>${nombre}</span></div><i class='sidebar-course__content-icon'></i></a></li>`;
}
